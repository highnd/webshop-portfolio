...
const HeroSection = () => {
  ...
  return (
    <section className="relative flex flex-col w-full md:h-[800px] overflow-hidden">
      <video
        autoPlay
        muted
        loop
        className="rotate-180 absolute top-[-320px] left-0 w-full h-full  object-cover z-[10]"
      >
      ...
      >
        <div className="relative z-50 h-full w-full flex flex-col gap-5 justify-center m-auto text-start">
          ...
          >
            ...
            <div className="countUpContainer md:pl-0 pl-2">
              ...
              <div className="sm:text-xs  text-[7px] uppercase tracking-[1px] leading-[1.2] text-transparent bg-clip-text bg-gradient-to-t from-purple-500 to-cyan-300">
                Years of experience
              </div>
            </div>
            {/* clients */}
          ...
          <motion.div
            variants={slideInFromTop}
            className="flex md:justify-start justify-center gap-3 "
          >
            ...
            <button className=" rounded-full border border-white/50 max-w-[250px] md:px-12 px-4 py-2 transition-all duration-300 flex items-center justify-center overflow-hidden hover:border-cyan-500 bg-cyan-500 hover:bg-transparent group">
              <span className="group-hover:-translate-y-[120%] group-hover:opacity-0 transition-all duration-500 font-bold md:text-md text-sm">
                Download CV
              </span>
              <AiOutlineDownload className="-translate-y-[120%] opacity-0 group-hover:flex group-hover:-translate-y-0 group-hover:opacity-100 transition-all duration-300 absolute text-[22px] text-cyan-500" />
            </button>
          </motion.div>
        </div>
        <motion.div
        ...
        <Image
          ...
          width={800}
          height={800}
          className="w-full h-[30rem] absolute bottom-0 left-0 z-10"
        />
      </motion.div>
    </section>
  );
